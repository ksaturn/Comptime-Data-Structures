...
pub fn ComptimePriorityQueue(comptime T: type, comptime capacity: usize, comptime Context: type, comptime compareFn: fn (context: Context, lhs: T, rhs: T) std.math.Order) type {
...
const MinHeap = ComptimePriorityQueue(u33, void, lessThan);
const MaxHeap = ComptimePriorityQueue(u33, void, greaterThan);
...
test "ComptimePriorityQueue: min heap put and pop" {
    var queue = ComptimePriorityQueue(u33, 6, void, lessThan).init({});
    try queue.put(54);
    try queue.put(12);
    try queue.put(77);
    try queue.put(23);
...
test "ComptimePriorityQueue: max heap put and pop" {
    var queue = ComptimePriorityQueue(u33, 6, void, greaterThan).init({});
    try queue.put(54);
    try queue.put(12);
    try queue.put(7);
    try queue.put(23);
...
test "ComptimePriorityQueue: min heap put and pop same" {
    var queue = ComptimePriorityQueue(u33, 6, void, lessThan).init({});
    try queue.put(1);
    try queue.put(1);
    try queue.put(2);
...
test "ComptimePriorityQueue: max heap put and pop same" {
    var queue = ComptimePriorityQueue(u33, 6, void, greaterThan).init({});
    try queue.put(1);
    try queue.put(1);
    try queue.put(2);
...
test "ComptimePriorityQueue: min heap pop empty" {
    var queue = ComptimePriorityQueue(u33, 6, void, lessThan).init({});
    try std.testing.expectEqual(null, queue.popOrNull());
}

test "ComptimePriorityQueue: min heap edge case 3 items" {
    var queue = ComptimePriorityQueue(u33, 3, void, lessThan).init({});
    try queue.put(9);
    try queue.put(3);
    try queue.put(2);
    try std.testing.expect(2 == queue.popOrNull());
...
test "ComptimePriorityQueue: min heap peek" {
    var queue = ComptimePriorityQueue(u33, 3, void, lessThan).init({});
...
test "ComptimePriorityQueue: min heap sift up with odd indices" {
    var queue = ComptimePriorityQueue(u33, 18, void, lessThan).init({});
...
test "ComptimePriorityQueue: max heap update" {
    var queue = ComptimePriorityQueue(u33, 3, void, greaterThan).init({});
    try queue.put(55);
    try queue.put(44);
    try queue.put(11);
...
test "ComptimePriorityQueue: max heap update same" {
    var queue = ComptimePriorityQueue(u33, 4, void, greaterThan).init({});
    try queue.put(1);
    try queue.put(1);
    try queue.put(2);
    try queue.put(2);
...
test "ComptimePriorityQueue: min heap update" {
    var queue = ComptimePriorityQueue(u33, 3, void, lessThan).init({});
    try queue.put(55);
    try queue.put(44);
    try queue.put(11);
...
test "ComptimePriorityQueue: min heap update same" {
    var queue = ComptimePriorityQueue(u33, 4, void, lessThan).init({});
    try queue.put(1);
    try queue.put(1);
    try queue.put(2);
    try queue.put(2);
...
test "ComptimePriorityQueue: min heap put and pop with context" {
    const context = [7]u33{ 5, 3, 4, 2, 2, 8, 0 };
    var queue = ComptimePriorityQueue(usize, 7, []const u33, contextLessThan).init(context[0..]);
    try queue.put(0);
    try queue.put(1);
    try queue.put(2);
    try queue.put(3);
